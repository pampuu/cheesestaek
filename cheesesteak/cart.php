...
if (isset($_SESSION['cart']) && count($_SESSION['cart']) > 0) {
    ...
    echo "<a href='review.php' class='btn' style='display: block; width: 100%; text-align: center; background-color: #333; color: #fff; padding: 10px; text-decoration: none; margin-top: 20px;'>Proceed to Checkout</a>";
} else {
